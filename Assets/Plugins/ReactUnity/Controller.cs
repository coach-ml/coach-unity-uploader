...
namespace ReactUnity
{
    public abstract class Controller<T> where T : IModel
    {
        ...
        public void SetState(T model)
        {
            if (this.StateChanged == null)
                throw new Exception("Tried to call SetState before the Controller was initialized! You cannot call SetState in the Controller constructor");
